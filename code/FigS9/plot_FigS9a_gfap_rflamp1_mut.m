% plot_FigS9a_gfap_rflamp1_mut.m
% Control fish — struggle-aligned cAMP shaded error bar
...
data_file = fullfile(root_dir, 'data', 'FigS9', 'FigS9a_gfap_rflamp1_mut_plot_data.mat');
...
png_file = fullfile(results_dir, 'FigS9a_gfap_rflamp1_mut.png');
pdf_file = fullfile(results_dir, 'FigS9a_gfap_rflamp1_mut.pdf');
exportgraphics(fig, png_file, 'Resolution', 300);
exportgraphics(fig, pdf_file, 'ContentType', 'vector');

fprintf('FigS9a_gfap_rflamp1_mut exported to:\n  %s\n  %s\n', png_file, pdf_file);
