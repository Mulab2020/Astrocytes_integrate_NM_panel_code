% plot_FigS4b_trace.m
% Independent plotting script for FigS4b — swim trace + drug onset line
...
data_file = fullfile(root_dir, 'data', 'FigS4', 'FigS4b_trace_plot_data.mat');
...
% Scale bar (x only, matching original)
...
png_file = fullfile(results_dir, 'FigS4b_trace.png');
pdf_file = fullfile(results_dir, 'FigS4b_trace.pdf');
exportgraphics(fig, png_file, 'Resolution', 300);
exportgraphics(fig, pdf_file, 'ContentType', 'vector');

fprintf('FigS4b exported to:\n  %s\n  %s\n', png_file, pdf_file);
