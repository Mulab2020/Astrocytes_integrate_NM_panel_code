% plot_FigS1d_NE_trace.m
% Independent plotting script for FigS1d NE — shaded error bar (mean +- SEM)
...
data_file = fullfile(root_dir, 'data', 'FigS1', 'FigS1d_NE_trace_plot_data.mat');
...
png_file = fullfile(results_dir, 'FigS1d_NE_trace.png');
pdf_file = fullfile(results_dir, 'FigS1d_NE_trace.pdf');
exportgraphics(fig, png_file, 'Resolution', 300);
exportgraphics(fig, pdf_file, 'ContentType', 'vector');

fprintf('FigS1d NE exported to:\n  %s\n  %s\n', png_file, pdf_file);
