% plot_FigS13_calcium.m
% PKA inhibition test (calcium) — control (kpep0) vs PKI (kpep5)
...
data_file = fullfile(root_dir, 'data', 'FigS13', 'FigS13_calcium_plot_data.mat');
...
png_file = fullfile(results_dir, 'FigS13_calcium.png');
pdf_file = fullfile(results_dir, 'FigS13_calcium.pdf');
exportgraphics(fig, png_file, 'Resolution', 300);
exportgraphics(fig, pdf_file, 'ContentType', 'vector');

fprintf('FigS13_calcium exported to:\n  %s\n  %s\n', png_file, pdf_file);
